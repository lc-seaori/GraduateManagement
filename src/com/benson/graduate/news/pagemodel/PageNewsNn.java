...
public class PageNewsNn {
	...
	private String platePname;  //所属父版块名称
	private String newsTypeStr;	//新闻类型
	private String plateName;	//所属于板块名称
	...
	public String getPlatePname() {
		return platePname;
	}
	public void setPlatePname(String platePname) {
		this.platePname = platePname;
	}
