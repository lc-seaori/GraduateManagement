 ...
 *
 */
@Controller("exportStuInfosAction")
@Scope("prototype")
public class DataManagement_ExportStuInfosDataAction extends BaseAction{
...
//		System.out.println("测试数据:    "+departmentSelected+"   "+majorFieldSelected+"    "+clazzSelected);
		...
		//导出已经通过审核的学生源信息，也就是学生信息
		List<Student> students= studentService.findStudentsForExport(departmentId, majorFieldId, clazzId);
		HSSFWorkbook book=dataManagementService.createHSSFWorkbookByStusList(students,type);
	 ...
	 * @throws IOException 
	 */
	public String exportStuInfos() throws IOException{
		return "success";
	}
