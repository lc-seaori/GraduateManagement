...
<div class="easyui-panel" style="padding: 30px 70px 50px 70px" align="center">
	<s:form id="addMajorForm" namespace="/" method="post" theme="simple" enctype="multipart/form-data">
		<s:hidden name="id"/>
		<table cellpadding="7">
			<tr>
				<td>所属学院：</td>
				<td>
					...
					id="departmentSelected" name="departmentSelected" style="width: 140px" 
	...
	<div style="text-align: center; padding: 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" 
			onclick="toAddMajors('#addMajorForm')">添加</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-no" 
			onclick="exitAddMajorPage()">关闭</a>
	</div>
</div>
<script type="text/javascript">
	...
	function toAddMajors(form){
		...
		$(form).ajaxSubmit({
		     type: 'post',
		     url: "System_Major_addMajor.action",
		     success: 
		    	function(data){
		    		...
		    		if (result.success){
						...
						$.messager.alert("操作提示","添加专业失败" ,"error");
					}
				}
		});    
	}
