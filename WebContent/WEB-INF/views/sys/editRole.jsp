...
<div class="easyui-panel" style="padding: 30px 70px 50px 70px" align="center">
	<s:form id="editRoleForm" namespace="/" method="post" theme="simple" enctype="multipart/form-data">
		<s:hidden name="id"/>
		<s:hidden name="resourceIds"></s:hidden>
		<table cellpadding="7">
			<tr>
				<td>角色名称：</td>
				<td>
	...
	<div style="text-align: center; padding: 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" 
			onclick="toEditRoles('#editRoleForm')">更新</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-no" 
			onclick="exitEditRolePage()">关闭</a>
	</div>
</div>
<script type="text/javascript">
	...
	function toEditRoles(form){
		...
		$(form).ajaxSubmit({
		     type: 'post',
		     url: "System_Role_doEditRole.action",
		     success: 
		    	function(data){
		    		...
		    		if (result.success){
						...
						$.messager.alert("操作提示","修改角色信息失败" ,"error");
					}
				}
		});    
	}
