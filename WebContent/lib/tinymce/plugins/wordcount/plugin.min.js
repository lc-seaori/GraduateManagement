...
function(a) {
	if(a.settings.selector == 'textarea#ybolo-wx-editor'
		|| a.settings.selector == 'textarea#ybolo-pc-editor'){
		 a.on("init",
			    function() {
			        window.setTimeout(function() {
			        	   a.on("keyup",
			       	            function(f) {
			       	                a.settings.custom_call_back()
			       	            });
			        	},
			        0);
	         });
	    ...
	    function b() {
	        a.theme.panel.find("#wordcount").text(["字数: {0}", e.getCount()])
	    }
	    var c, d, e = this;
